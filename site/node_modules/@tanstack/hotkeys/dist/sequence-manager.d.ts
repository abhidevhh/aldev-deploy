...
//#region src/sequence-manager.d.ts
 ...
 */
interface SequenceOptions extends Omit<HotkeyOptions, 'requireReset'> {
...
declare class SequenceManager {
   ...
   */
  register(sequence: HotkeySequence, callback: HotkeyCallback, options?: SequenceOptions): SequenceRegistrationHandle;
  /**
...
//#endregion
export { HotkeySequence, SequenceManager, SequenceOptions, SequenceRegistrationHandle, SequenceRegistrationView, createSequenceMatcher, getSequenceManager };
