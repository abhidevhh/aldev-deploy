...
function cjsInterop(options) {
	...
	const matchesDependencies = (value) => {
		if (!(value in matchedDependencies)) matchedDependencies[value] = dependencies.some((dependency) => minimatch(value, dependency));
