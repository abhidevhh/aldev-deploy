import {
  ...
  name
} from "./chunk-7ACPD7CC.js";
import {
  init_browser,
  parse
} from "./chunk-UQ3RP2YN.js";
import {
  __commonJS,
  __esm,
  __toESM
...
function symbolToEstree(symbol) {
  const name2 = wellKnownSymbols.get(symbol);
  if (name2) {
    return {
      type: "MemberExpression",
      computed: false,
...
var init_estree_util_value_to_estree = __esm({
  "../../node_modules/estree-util-value-to-estree/dist/estree-util-value-to-estree.js"() {
    wellKnownSymbols = /* @__PURE__ */ new Map();
    for (const name2 of Reflect.ownKeys(Symbol)) {
      const value = Symbol[name2];
      if (typeof value === "symbol") {
        wellKnownSymbols.set(value, name2);
      }
    }
  }
});
    ...
    module.exports = (function() {
      ...
      function parse2(input) {
        var options = arguments.length > 1 ? arguments[1] : {}, peg$FAILED = {}, peg$startRuleFunctions = { start: peg$parsestart }, peg$startRuleFunction = peg$parsestart, peg$c0 = [], peg$c1 = function() {
          ...
          addNode(node("ObjectPath", name2, line, column));
        }, peg$c12 = function(name2) {
          addNode(node("ArrayPath", name2, line, column));
...
// ../../node_modules/remark-mdx-frontmatter/index.js
var import_toml, remarkMdxFrontmatter, remark_mdx_frontmatter_default;
var init_remark_mdx_frontmatter = __esm({
  "../../node_modules/remark-mdx-frontmatter/index.js"() {
    init_estree_util_is_identifier_name();
    init_estree_util_value_to_estree();
    import_toml = __toESM(require_toml());
    init_browser();
    remarkMdxFrontmatter = ({ name: name2 = "frontmatter", parsers } = {}) => {
      if (!name(name2)) {
        throw new Error(`Name this should be a valid identifier, got: ${JSON.stringify(name2)}`);
      }
      const allParsers = {
        yaml: parse,
    ...
    remark_mdx_frontmatter_default = remarkMdxFrontmatter;
  }
});
init_remark_mdx_frontmatter();
export {
  remark_mdx_frontmatter_default as default
};
//# sourceMappingURL=remark-mdx-frontmatter-G7FEV6HS.js.map
