...
import {
  ...
  parseFragment,
  serializeOuter
} from "./chunk-Y2PX4IPR.js";
import "./chunk-A7GIIBNI.js";
import "./chunk-MZJAZIIM.js";
import "./chunk-NAQI7SW5.js";
import "./chunk-C7647EOS.js";
import {
  __commonJS,
  __esm,
  __export,
...
var init_decode_data_xml2 = __esm({
  "../../node_modules/entities/dist/esm/generated/decode-data-xml.js"() {
    init_decode_shared();
    xmlDecodeTree = decodeBase64("AAJhZ2xxBwARABMAFQBtAg0AAAAAAA8AcAAmYG8AcwAnYHQAPmB0ADxg9SFvdCJg");
  }
});
...
function getDecoder2(decodeTree) {
  let returnValue = "";
  const decoder = new EntityDecoder2(decodeTree, (data2) => returnValue += fromCodePoint2(data2));
...
var CharCodes2, TO_LOWER_BIT2, EntityDecoderState2, DecodingMode2, EntityDecoder2, htmlDecoder2, xmlDecoder2;
var init_decode2 = __esm({
  "../../node_modules/entities/dist/esm/decode.js"() {
    ...
    htmlDecoder2 = getDecoder2(htmlDecodeTree);
    xmlDecoder2 = getDecoder2(xmlDecodeTree);
  }
});
  ...
  "../../node_modules/css-select/lib/esm/attributes.js"() {
    ...
    attributeRules = {
      ...
      start(next2, data2, options) {
        ...
        return (elem) => {
          var _a4;
          return !!((_a4 = adapter2.getAttributeValue(elem, name)) === null || _a4 === void 0 ? void 0 : _a4.startsWith(value)) && next2(elem);
        };
      },
        ...
        if (shouldIgnoreCase(data2, options)) {
          ...
          return (elem) => {
            var _a4;
            return ((_a4 = adapter2.getAttributeValue(elem, name)) === null || _a4 === void 0 ? void 0 : _a4.substr(len).toLowerCase()) === value && next2(elem);
          };
        }
        return (elem) => {
          var _a4;
          return !!((_a4 = adapter2.getAttributeValue(elem, name)) === null || _a4 === void 0 ? void 0 : _a4.endsWith(value)) && next2(elem);
        };
      },
      any(next2, data2, options) {
        ...
        return (elem) => {
          var _a4;
          return !!((_a4 = adapter2.getAttributeValue(elem, name)) === null || _a4 === void 0 ? void 0 : _a4.includes(value)) && next2(elem);
        };
      },
...
function compileRules(rules, options, context) {
  var _a4;
  return rules.reduce((previous, rule) => previous === import_boolbase5.default.falseFunc ? import_boolbase5.default.falseFunc : compileGeneralSelector(previous, rule, options, context, compileToken), (_a4 = options.rootFunc) !== null && _a4 !== void 0 ? _a4 : import_boolbase5.default.trueFunc);
}
...
var init_esm8 = __esm({
  "../../node_modules/css-select/lib/esm/index.js"() {
    init_esm5();
    import_boolbase6 = __toESM(require_boolbase());
    init_compile2();
    init_subselects();
    init_pseudo_selectors();
...
var init_esm9 = __esm({
  "../../node_modules/cheerio-select/lib/esm/index.js"() {
    ...
    init_esm8();
    init_esm5();
    boolbase7 = __toESM(require_boolbase());
    init_helpers2();
    init_positionals();
    init_esm8();
    UNIVERSAL_SELECTOR = {
  ...
  "../../node_modules/parse5-htmlparser2-tree-adapter/dist/index.js"() {
    ...
    adapter = {
      ...
      getDocumentTypeNodeName(doctypeNode) {
        var _a4;
        return (_a4 = doctypeNode["x-name"]) !== null && _a4 !== void 0 ? _a4 : "";
      },
      getDocumentTypeNodePublicId(doctypeNode) {
        var _a4;
        return (_a4 = doctypeNode["x-publicId"]) !== null && _a4 !== void 0 ? _a4 : "";
      },
      getDocumentTypeNodeSystemId(doctypeNode) {
        var _a4;
        return (_a4 = doctypeNode["x-systemId"]) !== null && _a4 !== void 0 ? _a4 : "";
      },
      //Node types
...
function parseWithParse5(content, options, isDocument2, context) {
  var _a4;
  (_a4 = options.treeAdapter) !== null && _a4 !== void 0 ? _a4 : options.treeAdapter = adapter;
  if (options.scriptingEnabled !== false) {
    options.scriptingEnabled = true;
  }
  return isDocument2 ? parse(content, options) : parseFragment(context, content, options);
}
...
// ../../node_modules/whoops/src/index.js
var require_src3 = __commonJS({
  "../../node_modules/whoops/src/index.js"(exports, module) {
    "use strict";
...
// ../../node_modules/metascraper/src/rules.js
var require_rules = __commonJS({
  "../../node_modules/metascraper/src/rules.js"(exports, module) {
    "use strict";
...
// ../../node_modules/metascraper/src/get-data.js
var require_get_data = __commonJS({
  "../../node_modules/metascraper/src/get-data.js"(exports, module) {
    "use strict";
    var debug = require_src()("metascraper:get-data");
    var { findRule, has: has2 } = require_src2();
      ...
      await Promise.all(
        rules.map(async ([propName, innerRules]) => {
          ...
          try {
            ...
            normalizedValue = has2(value) ? value : null;
          } catch (error) {
            status = "error";
            debug("rule:error", {
              propName,
          ...
          data2[propName] = normalizedValue;
        })
      );
      return data2;
    };
...
var require_src4 = __commonJS({
  "../../node_modules/metascraper/src/index.js"(exports, module) {
    var { isUrl } = require_src2();
    var { load: load2 } = (init_browser(), __toCommonJS(browser_exports));
    var whoops = require_src3();
    ...
    module.exports = (rules) => {
      ...
      return async ({
        ...
        return getData({
          url,
          htmlDom: htmlDom ?? load2(html3, { baseURI: url }),
...
//# sourceMappingURL=metascraper.js.map
