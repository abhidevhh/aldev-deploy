...
var require_github_slugger = __commonJS({
  "../../node_modules/github-slugger/index.js"(exports, module) {
    ...
    module.exports = BananaSlug2;
    var own = Object.hasOwnProperty;
    function BananaSlug2() {
      const self = this;
      if (!(self instanceof BananaSlug2)) return new BananaSlug2();
      self.reset();
    }
    BananaSlug2.prototype.slug = function(value, maintainCase) {
      const self = this;
    ...
    BananaSlug2.prototype.reset = function() {
    ...
    BananaSlug2.slug = slugger;
  }
});

// ../../node_modules/remark-slug/node_modules/mdast-util-to-string/lib/index.js
var emptyOptions = {};
...
// ../../node_modules/remark-slug/node_modules/unist-util-is/lib/index.js
var convert = (
  /**
   * @type {(
...
// ../../node_modules/remark-slug/node_modules/unist-util-visit-parents/lib/color.browser.js
function color(d) {
  return d;
}

// ../../node_modules/remark-slug/node_modules/unist-util-visit-parents/lib/index.js
var CONTINUE = true;
var EXIT = false;
var SKIP = "skip";
var visitParents = (
  ...
  (function(tree, test, visitor, reverse) {
    ...
    function factory(node2, index, parents) {
      ...
      function visit2() {
        ...
        let offset;
        let grandparents;
        if (!test || is2(node2, index, parents[parents.length - 1] || null)) {
...
// ../../node_modules/remark-slug/node_modules/unist-util-visit/lib/index.js
var visit = (
  /**
   * @type {(
   *   (<Tree extends Node, Check extends Test>(tree: Tree, test: Check, visitor: BuildVisitor<Tree, Check>, reverse?: boolean | null | undefined) => void) &
...
function remarkSlug() {
  return (tree) => {
    ...
    visit(tree, "heading", (node2) => {
      ...
      let id = props.id;
      id = id ? slugs.slug(String(id), true) : slugs.slug(toString(node2));
      data.id = id;
      props.id = id;
    });
  };
...
//# sourceMappingURL=remark-slug.js.map
