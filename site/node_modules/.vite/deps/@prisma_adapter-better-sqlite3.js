...
var require_function = __commonJS({
  "../../node_modules/better-sqlite3/lib/methods/function.js"(exports, module) {
    "use strict";
    var { getBooleanOption, cppdb } = require_util2();
    module.exports = function defineFunction(name2, options, fn) {
      if (options == null) options = {};
...
var require_aggregate = __commonJS({
  "../../node_modules/better-sqlite3/lib/methods/aggregate.js"(exports, module) {
    "use strict";
    var { getBooleanOption, cppdb } = require_util2();
    module.exports = function defineAggregate(name2, options) {
      if (typeof name2 !== "string") throw new TypeError("Expected first argument to be a string");
...
var require_table = __commonJS({
  "../../node_modules/better-sqlite3/lib/methods/table.js"(exports, module) {
    "use strict";
    var { cppdb } = require_util2();
    module.exports = function defineTable(name2, factory) {
      if (typeof name2 !== "string") throw new TypeError("Expected first argument to be a string");
...
var debug2 = Debug("prisma:driver-adapter:better-sqlite3:conversion");
function mapDeclType(declType) {
  ...
  switch (declType.toUpperCase()) {
    ...
    default:
      debug2("unknown decltype:", declType);
      return null;
  }
}
...
var debug22 = Debug("prisma:driver-adapter:better-sqlite3");
var BetterSQLite3Queryable = class {
  ...
  onError(error) {
    debug22("Error in performIO: %O", error);
...
//# sourceMappingURL=@prisma_adapter-better-sqlite3.js.map
