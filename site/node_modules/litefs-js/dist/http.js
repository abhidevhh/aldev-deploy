 ...
 * ...
 */
export async function ensurePrimary(res) {
 ...
 */
export async function setTxCookie(res) {
 ...
 * @returns {Promise<void>}
 */
export async function deleteTxCookie(res) {
    appendHeader(res, 'Set-Cookie', getTxSetCookieHeader(0, { expires: new Date(0) }));
}
 ...
 */
export async function handleTransactionalConsistency(req, res) {
    const result = await checkCookieForTransactionalConsistency(req.headers.cookie);
