 ...
 * ...
 */
export declare function ensurePrimary(): Promise<boolean>;
/**
 ...
 */
export declare function ensureInstance(instance: string): Promise<true>;
/**
 ...
 * ...
 */
export declare function getReplayResponse(instance: string): Response;
 ...
 * instanceof Response.
 */
export declare function handleTransactionalConsistency(request: Request): Promise<ConsistencyResult>;
/**
 ...
 */
export declare function appendTxNumberCookie(request: Request, headers: Headers): Promise<void>;
