import type { ZodType, ZodTypeDef, ZodTypeAny, input, output } from 'zod/v3';
/**
...
export declare function configureCoercion(config?: {
     ...
     * ```
     */
    coerceFormValue<Schema extends ZodTypeAny>(type: Schema): ZodType<output<Schema>, ZodTypeDef, input<Schema>>;
    /**
     ...
     * ```
     */
    coerceStructure<Schema extends ZodTypeAny>(type: Schema): ZodType<input<Schema>, ZodTypeDef, input<Schema>>;
};
export declare const coerceFormValue: <Schema extends ZodTypeAny>(type: Schema) => ZodType<output<Schema>, ZodTypeDef, input<Schema>>, coerceStructure: <Schema extends ZodTypeAny>(type: Schema) => ZodType<input<Schema>, ZodTypeDef, input<Schema>>;
