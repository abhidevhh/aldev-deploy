...
function enableTypeCoercion(type, options) {
  ...
  if (coercion) {
    schema = zod.any().transform(coercion).pipe(type);
    ...
    schema = zod.any().transform(value => {
      ...
      return value;
    }).pipe(new zod.ZodObject(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
    ...
    schema = zod.any().transform(options.stripEmptyValue).pipe(new zod.ZodOptional(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      innerType: enableTypeCoercion(def.innerType, options)
    })));
  } else if (def.typeName === 'ZodDefault') {
    var defaultValue = def.defaultValue();
    schema = zod.any().transform(options.stripEmptyValue).pipe(new zod.ZodDefault(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
    ...
    schema = zod.any().transform(value => {
      ...
      return value;
    }).pipe(new zod.ZodDiscriminatedUnion(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      options: def.options.map(option => enableTypeCoercion(option, options)),
    ...
    schema = new zod.ZodBranded(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      type: enableTypeCoercion(def.type, options)
    }));
    ...
    schema = zod.lazy(() => enableTypeCoercion(inner, options));
  }
  if (type !== schema) {
