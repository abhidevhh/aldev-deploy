...
date: 2015-11-16
description: An argument for why use of semicolons in JavaScript source is a preference
meta:
  keywords:
    - javascript
    - ES6
bannerCloudinaryId: abhidev.com/content/blog/semicolons-in-javascript-a-preference/banner
...
right pinky (though
[sometimes it gets hurt](https://x.com/abhidev/status/925901200624558080))
...
preference**! Catch you on the [twitters](https://x.com/abhidev)!
