...
**[Watch "Use a status enum instead of booleans" on egghead.io](https://egghead.io/lessons/javascript-use-a-status-enum-instead-of-booleans?pl=abhi-s-blog-posts-as-screencasts-eefa540c)**

https://egghead.io/lessons/javascript-use-a-status-enum-instead-of-booleans?pl=abhi-s-blog-posts-as-screencasts-eefa540c
