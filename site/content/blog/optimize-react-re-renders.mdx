...
date: 2019-06-24
description: Without using React.memo, PureComponent, or shouldComponentUpdate
categories:
  - react
meta:
  keywords:
...
translations:
  - language: Português (Brasil)
    link: https://dev.to/ronaizacardoso/um-simples-truque-para-otimizar-as-re-renderizacoes-no-react-bo0
    author:
      name: ronaiza
      link: https://github.com/ronaiza-cardoso
  - language: 한국어
    link: https://dkrnfls.tistory.com/413
    author:
      name: 정우병
      link: https://github.com/woobottle
bannerCloudinaryId: abhidev.com/content/blog/optimize-react-re-renders/banner
...
https://x.com/abhidev/status/1143200604065431552

After reading this blog post,
[Brooks Lybrand](https://x.com/BrooksLybrand) implemented this trick and
this was the result:

https://x.com/BrooksLybrand/status/1149800755404185609
...
this is that
["It's both natural for composition _and_ acts as an optimization opportunity."](https://x.com/dan_abramov/status/1143201204094341120)
...
<callout-info class="aside">
	...
	get this optimization, [as React has a special case for that
	here](https://github.com/facebook/react/blob/d420d2ccb6223a66d5e8fe824ac0d31ed5bf87a1/packages/react-reconciler/src/ReactFiberBeginWork.js#L2576),
