...
In [my Learn React Hooks workshop](https://abhidev.com/hooks) material, we
have an exercise where we build a tic-tac-toe game using React's `useState` hook
(based on the official React tutorial).
[Here's the Github file for the finished version of that exercise](https://github.com/abhidev/react-hooks/blob/main/src/final/04.js)
