...
When
[I released the 2021 update to abhidev.com](/blog/how-i-built-a-modern-website-in-2021),
...
1. Double-check volumes in `kcd` (`dfw` is primary)
...
abhidev.com because my app and data are side-by-side in a region as close to
