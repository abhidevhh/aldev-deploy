...
date: 2018-06-15
description:
  Even better accessibility, React Native and ReasonReact support, even simpler
  API, improved docs, new examples site, Flow and TypeScript...
meta:
  keywords:
    - react
    - preact
    - react native
    - javascript
bannerCloudinaryId: unsplash/photo-1517405591683-0d4436276e8b
bannerCredit: Photo by [Philip Veater](https://unsplash.com/photos/eQQfYv7bhwU)
---
...
### Improved Accessibility ([**#a11y**](https://x.com/hashtag/a11y))
...
[![Screenshot of downshift code in React Native from Eli](https://res.cloudinary.com/abhidev-com/image/upload/v1625032682/abhidev.com/content/blog/downshift-2-0-0-released/0.png)](https://github.com/downshift-js/downshift/issues/185#issuecomment-365965566)
...
- Codesandbox:
  [codesandbox.io/s/github/abhidev/downshift-examples](https://codesandbox.io/s/github/abhidev/downshift-examples)
- GitHub:
  [https://github.com/abhidev/downshift-examples](https://github.com/abhidev/downshift-examples)
