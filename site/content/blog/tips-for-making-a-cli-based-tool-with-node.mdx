...
date: 2016-11-18
description:
  I got this question on my AMA and decided to turn the answer into a formal
  blogpost.
meta:
  keywords:
    - javascript
    ...
    - Command Line
    - Node
bannerCloudinaryId: abhidev.com/content/blog/tips-for-making-a-cli-based-tool-with-node/banner
---
...
[split-guide](https://github.com/abhidev/split-guide). You'll see the CLI
code lives
[here](https://github.com/abhidev/split-guide/blob/fb4b2a2ebc1fb8c3c010c2af1318861b8bb1bb13/src/bin/index.js).
And I tell npm to use the transpiled version of that file as the `bin` in the
`package.json`
[here](https://github.com/abhidev/split-guide/blob/fb4b2a2ebc1fb8c3c010c2af1318861b8bb1bb13/package.json#L12-L14)
...
[here](https://github.com/abhidev/split-guide/blob/fb4b2a2ebc1fb8c3c010c2af1318861b8bb1bb13/package-scripts.js#L13)
(I'm using [`p-s`](https://github.com/abhidev/p-s) for my scripts).
...
my [`react-jest-workshop`](https://github.com/abhidev/react-jest-workshop)
[here](https://github.com/abhidev/react-jest-workshop/blob/c43eaa13eb0ca203d7ed2b771b85e61ca5e539b0/package.json#L12).

Let's look again at
[the actual](https://github.com/abhidev/split-guide/blob/master/src/bin/index.js)
[`bin`](https://github.com/abhidev/split-guide/blob/master/src/bin/index.js)
[file](https://github.com/abhidev/split-guide/blob/master/src/bin/index.js)
itself now. There are a few things to note:

1.  [The first line](https://github.com/abhidev/split-guide/blob/fb4b2a2ebc1fb8c3c010c2af1318861b8bb1bb13/src/bin/index.js#L1)
...
3.  You'll also notice that I'm not doing a lot of logic in here. That's because
    ...
    [here](https://github.com/abhidev/split-guide/blob/fb4b2a2ebc1fb8c3c010c2af1318861b8bb1bb13/src/bin/index.test.js)
...
4.  The main logic for the package lives in the rest of the
    [`src`](https://github.com/abhidev/split-guide/tree/fb4b2a2ebc1fb8c3c010c2af1318861b8bb1bb13/src)
...
![See you on Twitter!](https://res.cloudinary.com/abhidev-com/image/upload/v1625033442/abhidev.com/content/blog/tips-for-making-a-cli-based-tool-with-node/0.png)
