...
meta:
  keywords:
    ...
    - open source
    - oss
bannerCloudinaryId: abhidev.com/content/blog/favor-progress-over-pride-in-open-source/banner
bannerCredit: Photo by [Morning Brew](https://unsplash.com/photos/X8-ogEgk338)
---

I have published [a lot of open source packages](http://npm.im/~abhidev).
...
[![download graph for glamorous](https://res.cloudinary.com/abhidev-com/image/upload/v1625032701/abhidev.com/content/blog/favor-progress-over-pride-in-open-source/glamorous-downloads.png)](https://www.npmtrends.com/glamorous)
