...
Here's [a slide](http://slides.com/abhidev/testing-workshop#/4/8) from my
Frontend Masters workshop:
["Testing JavaScript Applications"](https://frontendmasters.com/courses/testing-javascript).

![testing pyramid](https://res.cloudinary.com/abhidev-com/image/upload/v1625033547/abhidev.com/content/blog/write-tests/2.png)
...
https://x.com/abhidev/status/1141365123296051201
