...
date: 2017-06-06
description: When I use classes, when I don't, what I do instead, and why
meta:
  keywords:
    - javascript
bannerCloudinaryId: unsplash/photo-1453791052107-5c843da62d97
bannerCredit: "Obligatory semi-to-not-related header image via:
  [https://unsplash.com/photos/sMQiL_2v4vs](https://unsplash.com/photos/sMQiL_2\
  v4vs)"
---
...
![A Person instance with methods on __proto__](https://res.cloudinary.com/abhidev-com/image/upload/v1625032592/abhidev.com/content/blog/classes-complexity-and-functional-programming/0.png)
...
![The person3 object with just greeting and name](https://res.cloudinary.com/abhidev-com/image/upload/v1625032592/abhidev.com/content/blog/classes-complexity-and-functional-programming/1.png)
...
![See you on twitter!](https://res.cloudinary.com/abhidev-com/image/upload/v1625032591/abhidev.com/content/blog/classes-complexity-and-functional-programming/2.png)

See you [around](https://x.com/abhidev) friends!
...
[Addy Osmani](https://x.com/addyosmani)'s
...
![chrome devtools showing the object](https://res.cloudinary.com/abhidev-com/image/upload/v1625032591/abhidev.com/content/blog/classes-complexity-and-functional-programming/3.png)
...
are [other issues](https://x.com/BrendanEich/status/871876967796056067)
...
[WeakMap exercises](https://github.com/abhidev/es6-workshop/blob/2a6bf446c95a387c8e87c1398444733618265c8a/exercises-final/13_weakmap.test.js#L10-L23)
in the [es6–workshop](https://github.com/abhidev/es6-workshop).

#### Additional Reading

This article by [Tyler McGinnis](https://x.com/tylermcginnis) called
...
“[The Mostly Adequate Guide to Functional Programming](https://mostly-adequate.gitbook.io/mostly-adequate-guide/)”
by [Brian Lonsdorf](https://x.com/drboolean), and (for those of you with a
