...
meta:
  keywords:
    ...
    - Code
    - Macros
bannerCloudinaryId: abhidev.com/content/blog/make-maintainable-workarounds-with-codegen/banner
bannerCredit: Photo by [Alexandre Godreau](https://unsplash.com/photos/4NwJVVrsULk)
---
...
![a bird saying nope](https://res.cloudinary.com/abhidev-com/image/upload/v1625033102/abhidev.com/content/blog/make-maintainable-workarounds-with-codegen/0.gif)
...
![The big bird saying yep](https://res.cloudinary.com/abhidev-com/image/upload/v1625033102/abhidev.com/content/blog/make-maintainable-workarounds-with-codegen/1.gif)
...
[`babel-plugin-codegen`](https://github.com/abhidev/babel-plugin-codegen) is
a babel plugin I wrote inspired by my other plugin
[`babel-plugin-preval`](https://github.com/abhidev/babel-plugin-preval). Both
of these ship with a [babel-macro](https://github.com/abhidev/babel-macros)
