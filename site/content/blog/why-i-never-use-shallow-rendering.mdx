...
date: 2018-07-23
description:
  Tests should help me be confident that my application is working and there are
...
translations:
  - language: 日本語
    link: https://zenn.dev/longrun_jp/articles/why-i-never-use-shallow-rendering
    author:
      name: y-takebe
      link: https://github.com/y-takebe
bannerCloudinaryId: abhidev.com/content/blog/why-i-never-use-shallow-rendering/banner
bannerCredit: Photo by [Teddy Kelley](https://unsplash.com/photos/okavjRLgnjo)
---
...
<callout-success class="important">
	With shallow rendering, I can refactor my component's implementation and my
	tests break. With shallow rendering, I can break my application and my tests
	say everything's still working.
</callout-success>
...
[I recently asked folks](https://x.com/abhidev/status/1016084196421296133)
to tell me why they use shallow rendering. Here are a few of the things that
shallow rendering makes easier:

1.  [... for calling methods in React components](https://x.com/Raed667/status/1016095856481701888)
2.  [... it seems like a waste to render all of the children of each component under test, for every test, hundreds/thousands of times...](https://x.com/MattTrifilo/status/1016101577667403778)
3.  [For actual unit testing. Testing composed components introduces new dependencies that might trigger an error while the unit itself might still work as intended.](https://x.com/janhoogeveen/status/1016207627859251200)
...
is
[Testing composed components introduces new dependencies that might trigger an error while the unit itself might still work as intended.](https://x.com/janhoogeveen/status/1016207627859251200).
...
> [The more your tests resemble the way your software is used, the more confidence they can give you.](https://x.com/abhidev/status/977018512689455106)
>  — AbhiDev 👋
