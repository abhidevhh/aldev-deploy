---
title: Introducing the new abhidev.com
date: 2021-10-04
...
meta:
  keywords:
    ...
    - kcd teams
    - epic web discord
    - the call AbhiDev podcast
bannerCloudinaryId: abhi/riding-onewheel-outdoors-fast
...
- [The Engineering with AbhiDev Podcast](/chats) and [The call AbhiDev Podcast](/calls) have
...
- There are 2 self-paced workshops ([EpicReact.dev](https://abhidev.com) and
  [TestingJavaScript.com](https://abhidev.com)) and 9 courses (some
...
[The call AbhiDev Podcast](/calls) is awesome. Here's how it works: You record a ~2
...
![Kent's old profile picture with an arrow leading to Kent's new profile picture](https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/introducing-the-new-abhidev.com/new-abhi_luxjl8.png)
...
<Themed
	dark={
		<a href="/signup">
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/introducing-the-new-abhidev.com/choose-team_rynvdn"
				imgProps={{
	...
	light={
		<a href="/signup">
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/introducing-the-new-abhidev.com/choose-team-light_zze8cf"
				imgProps={{
					alt: 'Three koalas on snowboards in red, yellow, and blue',
				}}
			/>
...
## Engineering with AbhiDev Season 4

As part of this launch, I talked with a bunch of amazing folks for Season 4 of
[The Engineering with AbhiDev Podcast](/chats)! And there are 25 episodes! Twice as much
...
[![fathom analytics screenshot](https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/introducing-the-new-abhidev.com/fathom_gx7md5.png)](https://kcd.im/kcd-fathom)
...
[![metronome metrics screenshot](https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/introducing-the-new-abhidev.com/metronome_b08gpc.png)](https://kcd.im/kcd-metronome)
