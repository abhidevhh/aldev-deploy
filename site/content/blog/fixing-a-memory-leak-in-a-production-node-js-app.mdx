...
date: 2023-01-12
description: How I found and fixed a memory leak on abhidev.com
categories:
  - node
meta:
  keywords:
...
[to twitter](https://x.com/abhidev/status/1600230591429251072) on
December 6th):
...
Read more about [the features here](/blog/introducing-the-new-abhidev.com)
and read more about
...
[`mdx-bundler`](https://github.com/abhidev/mdx-bundler). I do it this way so
...
![Screenshot of the Fly metrics UI on a mobile device showing two firecracker graphs, one for load average and one for memory usage. There are two clear spikes of each and it looks not so good.](https://res.cloudinary.com/abhidev-com/image/upload/v1673553093/abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/two-spikes)
...
<ThemedBlogImage
	...
	darkCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/server-timing"
	lightCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/server-timing-light"
	imgProps={{
...
https://x.com/abhidev/status/1602770471685980160
...
<ThemedBlogImage
	transparentBackground
	darkCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/heapf32"
	lightCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/heapf32-light"
	imgProps={{
...
<div class="tweet-embed deleted">
  ...
  <blockquote><a
      target="_blank"
      rel="noreferrer noopener"
      href="https://x.com/abhidev"
    >@abhidev</a> shiki has a really bad memory leak on an earlier version and it's a little
...
<ThemedBlogImage
	transparentBackground
	darkCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/typed-arrays"
	lightCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/typed-arrays-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/cloudinary-strings"
	lightCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/cloudinary-strings-light"
	imgProps={{
...
<ThemedBlogImage
	transparentBackground
	darkCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/tls-connections"
	lightCloudinaryId="abhidev.com/content/blog/fixing-a-memory-leak-in-a-production-node-js-app/tls-connections-light"
	imgProps={{
