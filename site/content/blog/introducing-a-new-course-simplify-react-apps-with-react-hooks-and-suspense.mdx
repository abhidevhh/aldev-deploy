...
date: 2018-12-03
description:
  Learn about the massive improvements coming to function components in React
  via a fresh new course showing you how to refactor an existing...
meta:
  keywords:
    - react
    - react hooks
    - react suspense
bannerCloudinaryId: abhidev.com/content/blog/introducing-a-new-course-simplify-react-apps-with-react-hooks-and-suspense/banner
---
...
[_Maggie Appleton_](https://x.com/mappletons) _and_
[_Maxime Bourgeois_](https://x.com/MaximalGFX) _is just the absolute best.
It's just so good. 😍_
...
[a modern React codebase](https://github.com/abhidev/react-github-profile)
