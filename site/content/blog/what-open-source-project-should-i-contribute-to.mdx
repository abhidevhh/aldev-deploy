...
date: 2020-07-06
description:
  My silver bullet answer to this frequently posed question, and how to get
  started
meta:
  keywords:
    - open source
...
translations:
  - language: Español
    link: https://medium.com/@noeliadonato/a-qu%C3%A9-proyecto-de-c%C3%B3digo-abierto-deber%C3%ADa-contribuir-949bef467863
    author:
      name: Noelia Donato
      link: https://x.com/vamoacodear
bannerCloudinaryId: abhidev.com/content/blog/what-open-source-project-should-i-contribute-to/banner
bannerCredit: '[octodex.github.com](https://octodex.github.com/repo)'
---

This is a question I've had countless times:

https://x.com/sarna_pranu/status/672438850724175872

_[Pranu's first pull request came soon after tweeting this](https://github.com/Automattic/mongoose/pull/3644)_

https://x.com/geraldchecka/status/670445392706736128
...
project regularly. To do that, you need to have an understanding of the use
cases and pains associated with a particular tool or library. This is why I say
_it's best to contribute to something you use regularly_.
...
https://x.com/abhidev/status/1135687475110670341
...
[![Course Artwork](https://res.cloudinary.com/abhidev-com/image/upload/v1625033504/abhidev.com/content/blog/what-open-source-project-should-i-contribute-to/pull-request-art.png)](https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github)
...
(more [here](https://x.com/abhidev/status/672873736974897152)... we
_need_ to standardize on this).

Also, here are good resources for finding simple ways to contribute:

[**Your First PR (@yourfirstpr)**](https://x.com/yourfirstpr)

[**first-timers-only (@first_tmrs_only)**](https://x.com/first_tmrs_only)
...
[My first PR](http://firstpr.me/#abhidev) was to fix a typo in a comment
