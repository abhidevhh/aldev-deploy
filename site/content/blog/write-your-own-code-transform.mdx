...
date: 2018-06-04
description: How to write your own code macro with babel-plugin-macros 🎣
meta:
  keywords:
    - javascript
    - babel
bannerCloudinaryId: abhidev.com/content/blog/write-your-own-code-transform-for-fun-and-profit/banner
bannerCredit: Photo by [Mervyn Chan](https://unsplash.com/photos/RFXxBTHze_M)
---
...
2.  It [was added](https://github.com/fkling/astexplorer/pull/303) as an
    ...
    [@FWeinb](https://x.com/FWeinb)

Up until now, only early adopters have tried to
[write a macro](https://github.com/abhidev/babel-plugin-macros/blob/master/other/docs/author.md),
though there are a fair amount of
[people using](https://github.com/abhidev/babel-plugin-macros/blob/master/other/docs/user.md)
the growing list of
...
<callout-info class="aside">
	...
	this](https://astexplorer.net/#/gist/9d287441b6bd345f9e113c9c3b2b2aee/d5ebca867a522f8aa0120643883b97b83ee23fb4)
</callout-info>
...
<callout-info class="aside">
	...
	here](https://astexplorer.net/#/gist/6efcadfda8975787d515a4a37c1a600a/635ba8b54af89d52171739c43a9a8a41627d461a)
</callout-info>
