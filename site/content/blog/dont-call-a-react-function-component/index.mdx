...
bannerCredit: Photo by [Alexander Andrews](https://unsplash.com/photos/bxhYCD7cdq8)
---

import * as Comps from './components'

**[Watch "Fix 'React Error: Rendered fewer hooks than expected'" on egghead.io](https://egghead.io/lessons/egghead-fix-react-error-rendered-fewer-hooks-than-expected?pl=abhi-s-blog-posts-as-screencasts-eefa540c)**

https://egghead.io/lessons/egghead-fix-react-error-rendered-fewer-hooks-than-expected?pl=abhi-s-blog-posts-as-screencasts-eefa540c

I got a great question from [Taranveer Bains](https://github.com/tearingItUp786)
[on my AMA](https://github.com/abhidev/ama/issues/763) asking:
