...
date: 2018-06-01
description:
  Now featuring the latest React APIs (like context) and entirely new patterns
  (like state reducer props).
meta:
  keywords:
    - javascript
    - react
bannerCloudinaryId: abhidev.com/content/blog/updated-advanced-react-component-patterns/banner
bannerCredit:
  '[Advanced React Component Patterns](http://kcd.im/advanced-react) with [Kent
  C. Dodds](https://x.com/abhidev) (art by [Maggie
  Appleton](https://x.com/Mappletons))'
---
...
ALSO! You can
[follow along in codesandbox](https://codesandbox.io/s/github/abhidev/advanced-react-patterns-v2/tree/egghead)
right here:
...
https://x.com/abhidev/status/1002546068884787202
