...
date: 2018-05-07
description:
  Let's make a component that supports Render Props, Component Injection,
  Compound Components, the Provider Pattern, and Higher Order...
meta:
  keywords:
    - react
bannerCloudinaryId: abhidev.com/content/blog/mixing-component-patterns/banner
bannerCredit: Photo by [rawpixel.com](https://unsplash.com/photos/AWX44zfMV-M)
---
