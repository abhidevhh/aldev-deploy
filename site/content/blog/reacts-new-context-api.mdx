...
date: 2018-02-05
description:
  It's way more ergonomic, it's no longer "experimental," and it's now a
  first-class API! OH, AND IT USES A RENDER PROP!
meta:
  keywords:
    - javascript
    - react
bannerCloudinaryId: unsplash/photo-1491895200222-0fc4a4c35e18
bannerCredit: Photo by [JJ Ying](https://unsplash.com/photos/7JX0-bfiuxQ)
---
...
<callout-info>
	...
	hooks](https://reactjs.org/hooks) were released? Read all about it here:
	[https://abhidev.com/blog/react-hooks-whats-going-to-happen-to-react-context](/blog/react-hooks-whats-going-to-happen-to-react-context)
</callout-info>
...
![search result of context on the official react documentation site](https://res.cloudinary.com/abhidev-com/image/upload/v1625033305/abhidev.com/content/blog/reacts-new-context-api/0.png)
...
repository is from [Andrew Clark](https://x.com/acdlite) (react core team
...
- `React.createContext` which is passed the initial value (and optionally
  [a fancy opt-out function that uses a bitmask](https://x.com/acdlite/status/957446433656864768)).
...
["first-class feature"](https://x.com/acdlite/status/957445801302618112)
...
I recently [tweeted](https://x.com/abhidev/status/911276059051438082):

https://x.com/abhidev/status/911276059051438082
...
can get... [nested](https://x.com/acdlite/status/955955121979969537):

https://x.com/acdlite/status/955955121979969537
...
[jmeas](https://x.com/jmeaspls) to make it great:
...
[I noted on twitter recently](https://x.com/abhidev/status/956675313966239745)
(in response to [Dan Abramov](https://x.com/dan_abramov)'s
[tweet](https://x.com/dan_abramov/status/956674265104953344)):

https://x.com/abhidev/status/956675313966239745
