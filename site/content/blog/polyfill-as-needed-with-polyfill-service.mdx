...
date: 2018-08-06
description:
  How to maximize the performance of loading polyfills for your application
  users.
meta:
  keywords:
    - javascript
    - Polyfill
bannerCloudinaryId: unsplash/photo-1454537468202-b7ff71d51c2e
bannerCredit: Photo by [Susan Yin](https://unsplash.com/photos/ImoVrhUBeFs)
---

In another post ["What is a polyfill"](/blog/what-is-a-polyfill), I talked about
...
> So what did I do to fix my IE10 bug? Well, one thing that really bugs me is
...
That's this post! I'll explain how I created a `polyfill.js` endpoint that gives
...
by [Addy Osmani](https://x.com/addyosmani) (or
...
One ["fun" experience](https://x.com/abhidev/status/997228884864139264)
