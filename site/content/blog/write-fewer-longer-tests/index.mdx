...
translations:
  - language: Español
    ...
    author:
      name: Dany Paredes
      link: https://x.com/danywalls
  - language: 한국어
    link: https://rosetta.page/post/번역-더-적고-더-긴-테스트를-작성하세요-XmBzf
    author:
      name: 오인규
      link: https://github.com/gomjellie
...
1. The tests are not at all isolated (read
   [Test Isolation with React](https://abhidev.com/blog/test-isolation-with-react))
2. Mutable variables are shared between tests (read
   [Avoid Nesting when you're Testing](https://abhidev.com/blog/avoid-nesting-when-youre-testing))
...
![Syntax Highlighted Error Output](https://res.cloudinary.com/abhidev-com/image/upload/v1625033544/abhidev.com/content/blog/write-fewer-longer-tests/error.png)
...
and [avoid the test user](https://abhidev.com/blog/avoid-the-test-user), then
...
<callout-info class="aside">
	...
	here](https://github.com/abhidev/write-fewer-longer-tests-demo)
</callout-info>
