...
translations:
  ...
  - language: Português (do Brasil)
    link: https://dev.to/remix-run-br/por-que-eu-amo-remix-por-abhi-c-dodds-4379
    author:
...
[abhidev.com](https://abhidev.com) is completely custom built by me (and
...
<ThemedBlogImage
	darkCloudinaryId="abhidev.com/content/blog/why-i-love-remix/nested-errors-dark"
	lightCloudinaryId="abhidev.com/content/blog/why-i-love-remix/nested-errors-light"
	imgProps={{
