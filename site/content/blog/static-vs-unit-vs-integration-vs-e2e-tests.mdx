...
bannerCloudinaryId: abhidev.com/content/blog/unit-vs-integration-vs-e2e-tests/banner
bannerCredit: Screenshot from [TestingJavaScript.com](https://abhidev.com)
---

In my interview "Testing Practices with
[J.B. Rainsberger](https://x.com/jbrains)" available on
[TestingJavaScript.com](https://abhidev.com) he gave me a metaphor I
really like. He said:
...
This is why
[I created the Testing Trophy](https://x.com/abhidev/status/960723172591992832).
...
<div style={{ backgroundColor: 'white', padding: 30, borderRadius: '0.5rem' }}>
	[![The Testing
	Trophy](https://res.cloudinary.com/abhidev-com/image/upload/v1625033466/abhidev.com/content/blog/unit-vs-integration-vs-e2e-tests/testing-trophy.png)](https://abhidev.com)
</div>
...
[![The Testing Trophy with arrows indicating the trade-offs](https://res.cloudinary.com/abhidev-com/image/upload/v1625033467/abhidev.com/content/blog/unit-vs-integration-vs-e2e-tests/confidence-coefficient.png)](https://slides.com/abhidev/confident-react#/3/5)
