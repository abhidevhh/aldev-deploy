...
bannerCredit: Photo by [LoboStudio Hamburg](https://unsplash.com/photos/E3rMBrxqKRo)
---
...
![a dog trying to climb a slider but failing](https://res.cloudinary.com/abhidev-com/image/upload/v1625033446/abhidev.com/content/blog/tools-without-config/0.gif)
...
[Tim Arney](https://x.com/timarney). It's awesome. However, I've taken a
...
I've been using [a generator](https://github.com/abhidev/generator-kcd-oss)
for [my open source projects](https://github.com/abhidev) for over a year
...
[kcd-scripts](https://github.com/abhidev/kcd-scripts) which does the same
...
diffs 😍. I mean…
[check this out](https://x.com/abhidev/status/906238861067657221):

https://x.com/abhidev/status/906238861067657221
