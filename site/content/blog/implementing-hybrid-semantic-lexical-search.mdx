...
description:
  ...
  abhidev.com through three rounds of iteration with Cursor and GPT-5.4,
...
A few weeks ago I [added semantic search to abhidev.com](/blog/building-semantic-search-on-my-content). It lets you search with natural-language questions like ["How did Kent get his first job?"](/search?q=How+did+Kent+get+his+first+job?) or ["What's the best way to learn React?"](/search?q=What's+the+best+way+to+learn+React?) and get genuinely relevant results instead of a keyword-match list. I was pretty happy with it.
...
The PR is [#739](https://github.com/abhidev/abhidev.com/pull/739) if you want to see the full diff and review history.
