...
translations:
  ...
  - language: 한국어
    link: https://rosetta.page/post/번역-jsx에서-대신-삼항-연산자를-사용하세요-hrtyw
    author:
      name: 오인규
...
![PayPal page with contacts](https://res.cloudinary.com/abhidev-com/image/upload/v1625033483/abhidev.com/content/blog/use-ternaries-rather-than-and-and-in-jsx/contacts.png)

When a user came with no contacts, this is what they saw:

![PayPal page with 0 instead of contacts](https://res.cloudinary.com/abhidev-com/image/upload/v1625033483/abhidev.com/content/blog/use-ternaries-rather-than-and-and-in-jsx/no-contacts.png)
