...
`blog.abhidev.com` rather than `medium.com/@abhidev`. I am planning on
...
kit.com, I was able to simply update `kcd.im/news` to point to the new
...
[a new twitter account @abhi_writes for the purpose](https://x.com/abhi_writes).
