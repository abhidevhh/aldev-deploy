...
date: 2017-08-23
description:
  downshift 🏎 is the primitive you need to build simple, flexible, WAI-ARIA
  compliant React...
meta:
  keywords:
    - javascript
    ...
    - preact
    - open source
bannerCloudinaryId: unsplash/photo-1487445277584-73aff2146611
bannerCredit: Photo by [Isaac Jenks](https://unsplash.com/photos/j7lTi6MtYgk)
---

[_downshift 🏎_](https://github.com/downshift-js/downshift) _is the primitive
you need to build simple, flexible, WAI-ARIA compliant React
...
![Example of Google.com autocomplete/typeahead functionality](https://res.cloudinary.com/abhidev-com/image/upload/v1625033014/abhidev.com/content/blog/introducing-downshift-for-react/0.gif)
...
![gif showing the interaction](https://res.cloudinary.com/abhidev-com/image/upload/v1625033016/abhidev.com/content/blog/introducing-downshift-for-react/1.gif)
...
[Jared Forsyth](https://x.com/jaredforsyth)) and _they are the key to
...
[Ryan Florence](https://x.com/ryanflorence) teaches about
...
[Marcy Sutton](https://x.com/marcysutton) was kind enough to give one of
our examples
...
[an experiment using preact-habitat](https://github.com/abhidev/autocomplete-widget)
that gives
...
out to [Jason Miller](https://x.com/_developit) and
[Zouhir](https://x.com/_zouhir) for [`preact`](https://preactjs.com) and
...
![gif of a country selector experience on PayPal](https://res.cloudinary.com/abhidev-com/image/upload/v1625033014/abhidev.com/content/blog/introducing-downshift-for-react/2.gif)

We also use the same component in the recipient selector:

![gif of a recipient selector experience on PayPal](https://res.cloudinary.com/abhidev-com/image/upload/f_auto,q_auto,w_1400/v1625033014/abhidev.com/content/blog/introducing-downshift-for-react/3.gif)
...
[Ives van Hoorne](https://x.com/CompuIves)
([gif from his tweet](https://x.com/CompuIves/status/897970526832013315)):

![The codesandbox.io file chooser which you press ⌘+P to open](https://res.cloudinary.com/abhidev-com/image/upload/v1625033014/abhidev.com/content/blog/introducing-downshift-for-react/4.gif)

Fun fact: both of these solutions are also using
[match-sorter](https://github.com/abhidev/match-sorter), which is a user
...
[Ryan Florence](https://x.com/ryanflorence). His lesson on
...
And again, a big shoutout to [Jared Forsyth](https://x.com/jaredforsyth)
...
Special shoutout to [Travis Arnold](https://x.com/souporserious),
[Julien Goux](https://x.com/_jgx_),
[the_Simian](https://x.com/5imian), and
