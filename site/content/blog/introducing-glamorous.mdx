...
date: 2017-04-04
description:
  A styled-components 💅 and jsxstyle inspired solution for styling ⚛️ React
  Components from PayPal
meta:
  keywords:
    - react
    - javascript
    - css
bannerCloudinaryId: abhidev.com/content/blog/introducing-glamorous/banner
bannerCredit: The glamorous logo, shamelessly inspired (with permission) by
  styled-components
---
...
https://x.com/abhidev/status/840329548885557250
...
[rtl-css-js](https://github.com/abhidev/rtl-css-js)) and that's a hard
...
[_some_ dynamic capabilities](https://github.com/abhidev/glamorous/issues/4),
...
([inspired](https://github.com/abhidev/glamorous#inspiration)) API, small
...
https://x.com/abhidev/status/842881773180731392
...
[Alessandro Arnodo](https://x.com/vesparny)), glamorous also supports
theming:
...
[Server Side Rendering](https://github.com/abhidev/glamorous#server-side-rendering-ssr))!
...
[here](https://github.com/abhidev/glamorous/blob/2c5cba47ed83a744b8dec1ac8f85b560eae818b7/README.md#classname).
...
![](https://res.cloudinary.com/abhidev-com/image/upload/v1625033022/abhidev.com/content/blog/introducing-glamorous/0.png)
...
See you around on twitter: [@glamorousCSS](https://x.com/glamorousCSS) and
[@abhidev](https://x.com/abhidev)
