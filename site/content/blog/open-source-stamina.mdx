...
date: 2015-10-22
description: You contribute best to something you use regularly.
meta:
  keywords:
    - Nodejs
    - javascript
    - open source
bannerCloudinaryId: abhidev.com/content/blog/open-source-stamina/banner
---

This is likely the reason that
[TJ Holowaychuk](https://x.com/tjholowaychuk) gave his Node.js projects to
other maintainers (read
[Farewell Node.js](https://medium.com/@tjholowaychuk/farewell-node-js-4ba9e7f3e52b#.pj5yx57zb)).
This is also probably why [Vojta Jína](https://x.com/vojtajina) handed
[Karma](http://karma-runner.github.io) off to
[Mark Trostler](https://x.com/zzoass) and
[Friedel Ziegelmayer](https://x.com/dignifiedquire).
...
[TJ Holowaychuk](https://x.com/tjholowaychuk) still guides people on some
