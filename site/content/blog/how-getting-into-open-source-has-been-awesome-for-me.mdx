...
date: 2020-08-10
description: An anecdotal argument for contributing and using open source
meta:
  keywords:
    - open source
    - javascript
bannerCloudinaryId: unsplash/photo-1507290439931-a861b5a38200
bannerCredit: Photo by [Tj Holowaychuk](https://unsplash.com/photos/iGrsa9rL11o)
---

My first contribution to open source was extremely small:

[![first open source contribution](https://res.cloudinary.com/abhidev-com/image/upload/v1625032767/abhidev.com/content/blog/how-getting-into-open-source-has-been-awesome-for-me/0.png)](https://github.com/playframework/playframework/pull/616)
...
as a programmer. I later reminisced over the PR and made a thank you comment.
Which was later followed up by a total stranger and resulted in me getting some
digital cake!

![first open source contribution comment thread](https://res.cloudinary.com/abhidev-com/image/upload/v1625032767/abhidev.com/content/blog/how-getting-into-open-source-has-been-awesome-for-me/1.png)
...
[many](https://webpack.js.org/) [different](https://gruntjs.com)
[build](https://gulpjs.com) [systems](https://www.gnu.org/software/make)
...
where I've learned and experimented with several Continuous Integration services
and [automation tools](https://github.com/semantic-release/semantic-release).
It's been a lot of fun and helped keep my skills sharp.

Another thing that's cool about open source is that you get free code reviews
from expert developers when you make pull requests they need! How awesome is
that!?
...
[Brian Ford](https://x.com/briantford),
[Dan Abramov](https://x.com/dan_abramov), and
[Sebastian McKenzie](https://x.com/sebmck). But you don't have to make it
big in open source to get noticed.
[Matt Apperson](https://x.com/mattapperson),
[Rahat Khanna](https://x.com/mappmechanic), and
[Bram Borggreve](https://x.com/beeman_nl) and
[others](https://x.com/abhidev/status/671565082858418180) each spent
time making contributions to open source and have their jobs as a result.
...
[I asked](https://x.com/abhidev/status/671565082858418180) people if
...
([Christopher Chedeau](https://x.com/Vjeux) and
[John Lindquist](https://x.com/johnlindquist)) or speaking at conferences
([Olivier Combe](https://x.com/OCombe)). While not code contributions,
...
See you on [Twitter](https://x.com/abhidev) and
