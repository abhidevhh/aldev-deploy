...
date: 2018-04-23
description: Let's compare the before/after of React's new context API.
meta:
  keywords:
    - react
bannerCloudinaryId: abhidev.com/content/blog/migrating-to-reacts-new-context-api/banner
bannerCredit: Photo by [Marion Michele](https://unsplash.com/photos/z_eFLP9aS6s)
---
...
[Ryan Florence](https://x.com/ryanflorence)) that use the context API.
...
(hat-tip to [Michael Jackson](https://x.com/mjackson) and
[Ryan Florence](https://x.com/ryanflorence) for
...
[this trick](https://x.com/ryanflorence/status/981179212147998721) I got
from [Ryan Florence](https://x.com/ryanflorence).
