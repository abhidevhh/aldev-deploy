...
meta:
  keywords:
    - react
    - react hooks
bannerCloudinaryId: abhidev.com/content/blog/compound-components-with-react-hooks/banner
bannerCredit: Photo by [karl S](https://unsplash.com/photos/remgiCyeqHI)
translations:
  - language: 한국어
    link: https://nextjs-blog-gray.vercel.app/article/compound-components
    author:
      name: Dongho Kim
