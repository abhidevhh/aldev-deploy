...
date: 2018-04-02
description: A simpler replacement for enzyme that encourages good testing practices.
meta:
  keywords:
    - react
    - javascript
    - testing
bannerCloudinaryId: abhidev.com/content/blog/introducing-the-react-testing-library/banner
...
![The library emoji is the goat. No particular reason...](https://res.cloudinary.com/abhidev-com/image/upload/v1625033033/abhidev.com/content/blog/introducing-the-react-testing-library/0.png)
...
https://x.com/abhidev/status/977018512689455106
...
[Bergé Greg](https://x.com/neoziro) as well as inspiration from
[a fantastic (and short!) talk](https://youtu.be/qfnkDyHVJzs?t=5h39m19s) by
[Jamie White](https://x.com/jgwhite), I added several more and now I'm
...
- [`wait`](https://github.com/testing-library/react-testing-library/blob/fd2df8d18652786a95bce34741180137f9d2cef2/README.md#wait):
  ...
  [Łukasz Gozda Gandecki](https://x.com/lgandecki) who
