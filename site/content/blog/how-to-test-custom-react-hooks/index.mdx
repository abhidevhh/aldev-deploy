...
date: 2020-03-22
description: Get confidence your custom React hooks work properly with solid tests.
categories:
  - testing
meta:
  keywords:
...
[resemble the way the software will be used](https://x.com/abhidev/status/977018512689455106).
