...
**[Watch "Create App DevTools to enhance development productivity" on egghead.io](https://egghead.io/lessons/javascript-create-app-devtools-to-enhance-development-productivity?pl=abhi-s-blog-posts-as-screencasts-eefa540c)**

https://egghead.io/lessons/javascript-create-app-devtools-to-enhance-development-productivity?pl=abhi-s-blog-posts-as-screencasts-eefa540c
...
![Alianza Admin Portal with DevTools visible](https://res.cloudinary.com/abhidev-com/image/upload/v1625033119/abhidev.com/content/blog/make-your-own-dev-tools/alianza.png)
...
([repo](https://github.com/abhidev/app-dev-tools)) to show you an example of
...
https://x.com/abhidev/status/1229781024604708865
...
You can check out
[the `src/dev-tools/dev-tools.js` file in the repo](https://github.com/abhidev/app-dev-tools/blob/master/src/dev-tools/dev-tools.js)
...
[and repo](https://github.com/abhidev/app-dev-tools).
