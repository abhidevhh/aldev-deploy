...
date: 2015-10-27
description: Some solid reasons you should delete code that is not used
meta:
  keywords:
    - Git
    - github
    - Code
bannerCloudinaryId: abhidev.com/content/blog/please-dont-commit-commented-out-code/banner
...
[Gleb Bahmutov](https://x.com/bahmutov)'s
...
[Jamund Ferguson](https://x.com/xjamundx) on
...
<callout-info>_k-why-mahm _ —  Questions You Might Ask Me:</callout-info>
...
**Q:** What about
[examples for third party integrators](https://x.com/cssensei/status/658780781943328769)?
...
**Thank you** [Matt Zabriskie](https://x.com/mzabriskie),
[Lin Clark](https://x.com/linclark), [Kyle](https://x.com/getify),
[Jamund Ferguson](https://x.com/xjamundx), and
[Gleb Bahmutov](https://x.com/bahmutov) for reviewing this blog post.
