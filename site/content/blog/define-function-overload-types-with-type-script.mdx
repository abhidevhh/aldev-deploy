...
[`babel-plugin-macros`](https://github.com/abhidev/babel-plugin-macros) which
...
install [`codegen.macro`](https://github.com/abhidev/codegen.macro) and you
...
[babel-plugin-codegen `src/macro.ts` file](https://github.com/abhidev/babel-plugin-codegen/blob/master/src/macro.ts).
