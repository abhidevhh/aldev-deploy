...
date: 2019-05-20
description:
  How to handle user authentication in modern React Applications with context
  and hooks
categories:
  - react
meta:
  keywords:
    ...
    - router
    - authentication
bannerCloudinaryId: unsplash/photo-1461838432805-dff34fe2d8cb
bannerCredit: Photo by [Mike Enerio](https://unsplash.com/photos/H58bnmnedTc)
---

**[Watch "Organization of Authentication State in React Apps" on egghead.io](https://egghead.io/lessons/egghead-organization-of-authentication-state-in-react-apps?pl=abhi-s-blog-posts-as-screencasts-eefa540c)**

https://egghead.io/lessons/egghead-organization-of-authentication-state-in-react-apps?pl=abhi-s-blog-posts-as-screencasts-eefa540c
...
That's it.
[Most apps](https://x.com/abhidev/status/1131184429169168387) which
...
<callout-info class="aside">
	If you want to just look at how it's all done, then you can checkout [the
	bookshelf repo](https://github.com/abhidev/bookshelf) which I made for my
	[Build ReactJS Applications Workshop](https://abhidev.com/app).
</callout-info>
...
[The `auth-context.js` file](https://github.com/abhidev/bookshelf/blob/69bde2c117660bd988ffbc60f387165d2f852c62/src/context/auth-context.js)
...
[the bookshelf repo](https://github.com/abhidev/bookshelf)
([or even edit it on codesandbox](https://codesandbox.io/s/github/abhidev/bookshelf))
...
My friend [Ryan Chenckie](https://x.com/ryanchenkie) made a course all
about react authentication and security that I think you'll love.
[Check out his React Security Course](https://kcd.im/react-security).
