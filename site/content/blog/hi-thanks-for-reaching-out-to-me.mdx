...
bannerCloudinaryId: abhidev.com/content/blog/hi-thanks-for-reaching-out-to-me/banner
...
- [Email](/contact)
- [My AMA](https://github.com/abhidev/ama)
...
[tech chats](https://github.com/abhidev/ama/issues/125)).
...
source. I've archived [my AMA](https://github.com/abhidev/ama). I'm going to
...
- [EpicReact.dev](https://abhidev.com)
...
`team@abhidev.com` or `me@AbhiDev.com` and they can help you out.
Or if it's more general, `team@abhidev.com` goes to the same place as both of
those.
...
- ["Watch"](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/be-social#watching-a-repository)
  some of [my OSS repositories](https://github.com/abhidev) (especially
  [Testing Library ones](https://github.com/testing-library)).

Heck, you could even
[add this search](https://x.com/search?q=to%3Aabhidev&src=typed_query&f=live)
...
![hand wave](https://res.cloudinary.com/abhidev-com/image/upload/v1625032759/abhidev.com/content/blog/hi-thanks-for-reaching-out-to-me/wave.png)
