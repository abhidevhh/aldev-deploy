...
date: 2019-05-24
description: How your UI code has only two users, but the wrong tests can add a third
categories:
  - testing
meta:
  keywords:
    ...
    - javascript
    - react
bannerCloudinaryId: unsplash/photo-1497138169556-ba5743a6031c
bannerCredit: Photo by [Genevieve Perron-Migneron](https://unsplash.com/photos/vXZ_lC0XN4c)
---
...
[Advanced React Patterns](https://abhidev.com/patterns) material):
...
[look at the tests here](https://github.com/abhidev/advanced-react-patterns/blob/06a16f86d2397c4451da9faf9aeb64cbe4452ff6/src/__tests__/01.js)
