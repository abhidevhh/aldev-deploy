...
date: 2019-02-25
description: I've migrated from Medium to abhidev.com/blog... Here's why
meta:
  keywords:
    - career
...
I started out on Medium at `medium.com/@abhidev`, but after a while, I
...
or two ago I decided to create a "abhidev" publication and I used a (now
...
effort. Links to my articles on `blog.abhidev.com` have been shared with
...
[`kcd-blog-redirector`](https://github.com/abhidev/kcd-blog-redirector). I
...
I spent MANY more hours working on abhidev.com and preparing
abhidev.com/blog. In the last few weeks, I've spent many hours working on
migrating all my old Medium posts from blog.abhidev.com to
abhidev.com/blog. (You can watch those on
...
https://x.com/slicknet/status/1097584328962240512
...
1. [Search](https://github.com/abhidev/abhidev.com/issues/48)
2. [Category Pages](https://github.com/abhidev/abhidev.com/issues/49)
3. [Keyword Pages](https://github.com/abhidev/abhidev.com/issues/50)
4. [Fix the RSS Feed](https://github.com/abhidev/abhidev.com/issues/51)
