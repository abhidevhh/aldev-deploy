...
date: 2018-01-29
description:
  The merits and use cases of consolidating tools into one "zero config"
  toolkit.
meta:
  keywords:
    - javascript
translations:
  - language: Español
    link: https://medium.com/@enbonnet/juegos-de-herramientas-toolkits-8f3df94404e9
    author:
      name: Ender Bonnet
      link: https://x.com/enBonnet
bannerCloudinaryId: unsplash/photo-1478359900967-91ec0c6edc60
bannerCredit: Photo by [elizabeth lies](https://unsplash.com/photos/LUP8Tnwy7Ro)
---
...
[this](https://x.com/abhidev/status/941330985836208128):

https://x.com/abhidev/status/941330985836208128
...
[Dan Abramov](https://x.com/dan_abramov)'s
...
with no build configuration." (via [Ronald Rey](https://x.com/reyronald)
...
paypal and
[my own open source projects](https://github.com/abhidev/kcd-scripts).
...
[this git diff](https://x.com/abhidev/status/906238861067657221):

![git diff](https://res.cloudinary.com/abhidev-com/image/upload/v1625032630/abhidev.com/content/blog/concerning-toolkits/0.jpg)
...
[`kcd-scripts`](https://github.com/abhidev/kcd-scripts). Whenever there was a
...
In response to my tweet, [Sean T. Larkin](https://x.com/TheLarkInn)
[said](https://x.com/TheLarkInn/status/941375505730715648):

https://x.com/TheLarkInn/status/941375505730715648
...
[my tweet question](https://x.com/abhidev/status/950924626317656064)
and
[Dan's tweet question](https://x.com/dan_abramov/status/952248179478745089).
...
As [I tweeted](https://x.com/abhidev/status/942177631981649921) a while
back:

https://x.com/abhidev/status/942177631981649921
...
https://x.com/TheLarkInn/status/949050181261012992
...
One argument that [Rich Harris](https://x.com/Rich_Harris) made against
the `paypal-scripts`approach is
[this](https://x.com/Rich_Harris/status/941355856674934784):

https://x.com/Rich_Harris/status/941355856674934784
...
[TJ Holowaychuk](https://x.com/tjholowaychuk)
[gave](https://x.com/tjholowaychuk/status/941361591861223424) in the
thread:

https://x.com/tjholowaychuk/status/941361591861223424
...
I realize this post is a little bit more ranty than normal. I hope that it's
helpful though. I'd like to finish with a quote from
[Dan Abramov](https://x.com/dan_abramov)'s talk
["The Melting Pot of JavaScript" at Zeit Day](https://youtu.be/G39lKaONAlA?list=PLBnKlKpPeagkaVtpmZNK6XiWw8yNZmCxL):

> I've heard from several people that they've consolidated their companies tool
> dependencies into a single package and this worked really well for them. I
> encourage you to try this approach out and let me know what you think...
