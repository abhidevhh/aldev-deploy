...
translations:
  ...
  - language: Português (do Brasil)
    link: https://segredo.dev/como-saber-o-que-testar/?utm_source=abhidev&utm_medium=translate&utm_campaign=howknowtest
  - language: 한국어
...
bannerCredit: Photo by [Craig  Whitehead](https://unsplash.com/photos/aJfy0WtHtkc)
---
...
[TestingJavaScript.com](https://abhidev.com), I do talk about how to
...
<callout-info class="aside">
	...
	targets, I suggest watching [Aaron Abramov's](https://x.com/aarondjents) talk
	at [AssertJS 2018](https://2018.assertjs.com): [Establishing testing patterns
