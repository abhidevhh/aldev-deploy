...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/v2/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/network-chasm-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/network-chasm-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/v2/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/network-chasm-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/network-chasm-light"
				imgProps={{
					alt: 'Excalidraw diagram showing a box labeled client and a box labeled server with the words "Network Chasm" between them',
				}}
			/>
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/client-side-apps-only-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/client-side-apps-only-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/client-side-apps-only-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/client-side-apps-only-light"
				imgProps={{
					alt: 'Similar diagram as above with a box above "Client" that says "SPA" and an arrow from that over the network chasm pointing to a box that says "Node/Rails/PHP/Java/.Net". The row is labeled "Client-side apps"',
				}}
			/>
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/remixed-router-apps-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/remixed-router-apps-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/remixed-router-apps-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/remixed-router-apps-light"
				imgProps={{
					alt: 'Similar diagram as before except now the SPA box extends slightly further over the network chasm and the row is labeled "Remixed Router apps"',
				}}
			/>
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/backend-for-frontend-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/backend-for-frontend-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/backend-for-frontend-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/backend-for-frontend-light"
				imgProps={{
					alt: 'Similar to the diagrams before with the addition of a "Backend for frontend" row that shows Remix spanning over the client and network boundary into the Server and an arrow pointing to "Rails/PHP/Java/.Net"',
				}}
			/>
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/full-stack-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/full-stack-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/remix-the-yang-to-react-s-yin/full-stack-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/remix-the-yang-to-react-s-yin/full-stack-light"
				imgProps={{
					alt: 'Similar to the diagrams before with the addition of a "Full Stack" row that shows Remix spanning over the entire client, network chasm, and server',
				}}
			/>
