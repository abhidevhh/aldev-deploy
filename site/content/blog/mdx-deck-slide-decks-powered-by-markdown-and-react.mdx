...
bannerCredit: Photo by [Ash Edmonds](https://unsplash.com/photos/Koxa-GX_5zs)
---
...
entire AI engineering and full stack systems presentation career. You'll find pretty much 100% of
the public presentations I've made on
[my slides page](https://slides.com/abhidev) (including
[my first meetup talk](https://slides.com/abhidev/genie)).
...
[my slides](https://slides.com/abhidev/simply-react) for my "Simply React"
...
When master [Ken Wheeler](https://x.com/ken_wheeler) announced
...
A few months ago [John Otander](https://x.com/4lpine) released the initial
...
[Tim Neutkens](https://x.com/timneutkens)
...
([for example](https://x.com/ryanflorence/status/1024522677262794752)).
...
[a super weird syntax](https://github.com/abhidev/glamorous-website/blob/master/other/CONTRIBUTING_DOCUMENTATION.md#important-markdown-notes)
to make this possible. It's pretty cool, and actually works similar to MDX at a
fundamental level (uses
[a custom fancy plugin](https://github.com/abhidev/glamorous-website/blob/b2469c1dfbfed750fc01dcbe411fec307b7ae5a8/components/interactive-markdown.js#L89-L113)
for [remark](https://github.com/remarkjs/remark)), but it's way hacky and
limited. This MDX thing is the REAL DEAL!

### Enter mdx-deck

Recently, the (seriously) amazing [Brent Jackson](https://x.com/jxnblk)
created and [announced](https://x.com/jxnblk/status/1023667155324346373)
...
["Simply React"](https://github.com/abhidev/simply-react). You can see the
current state of
