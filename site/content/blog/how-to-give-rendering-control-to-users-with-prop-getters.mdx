...
date: 2017-10-02
description:
  Render props are awesome, put it together with prop getters and you have an
  awesome combination to give users of your React components...
meta:
  keywords:
    - javascript
    - react
bannerCloudinaryId: unsplash/photo-1464348123218-0ee63dfd2746
bannerCredit: Photo by [Annie Spratt](https://unsplash.com/photos/rx1iJ59jRyU)
---
...
<callout-info class="aside">
	...
	Props](https://egghead.io/lessons/react-use-prop-collections-with-render-props)
	and [Use Prop Getters with Render
	Props](https://egghead.io/lessons/react-use-prop-getters-with-render-props)
</callout-info>
...
![dog wagging the tail while waiting](https://res.cloudinary.com/abhidev-com/image/upload/v1625032844/abhidev.com/content/blog/how-to-give-rendering-control-to-users-with-prop-getters/0.gif)
...
got the idea from [Jared Forsyth](https://x.com/jaredforsyth) one day at
...
[`react-toggled`](https://github.com/abhidev/react-toggled).

![React toggled logo](https://res.cloudinary.com/abhidev-com/image/upload/v1625032841/abhidev.com/content/blog/how-to-give-rendering-control-to-users-with-prop-getters/1.png)

It's pretty small, so I'm just going to paste all of it here for you
([see the syntax highlighted file here](https://github.com/abhidev/react-toggled/blob/master/src/index.js)):
...
With that said,
[the biggest question I get from folks about "prop getters"](https://x.com/sprjrx/status/908367026619506688)
is:
...
- [`react-toggled`](https://github.com/abhidev/react-toggled) - Component to
