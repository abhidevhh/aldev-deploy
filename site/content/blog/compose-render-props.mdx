...
meta:
  keywords:
    ...
    - react
    - render props
bannerCloudinaryId: abhidev.com/content/blog/compose-render-props/banner
bannerCredit: Photo by [rawpixel.com](https://unsplash.com/photos/noorSVMhuPU)
---

Check this out:

https://x.com/abhidev/status/977317314361282560
...
My [next tweet](https://x.com/abhidev/status/977317793992503297) (after
the one lined above) was:

https://x.com/abhidev/status/977317793992503297
