...
date: 2018-05-14
description:
  What I do to learn and understand an open source project to which I want to
  contribute.
meta:
  keywords:
    - open source
    - web development
bannerCloudinaryId: unsplash/photo-1502086223501-7ea6ecd79368
bannerCredit: Photo by [Robert Collins](https://unsplash.com/photos/tvc5imO5pXk)
---
...
A [common](https://github.com/abhidev/ama/issues/57)
[question](https://github.com/abhidev/ama/issues/264) that I get from folks
...
- [React events in depth w/ AbhiDev, Ben Alpert, & Dan Abramov](https://youtu.be/dRo_egw7tBc?list=PLV5CVI1eNcJi8sor_aQ2AzOeQ3On3suOr)
