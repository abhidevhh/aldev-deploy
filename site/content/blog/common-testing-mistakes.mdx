...
meta:
  keywords:
    - javascript
    - testing
bannerCloudinaryId: abhidev.com/content/blog/common-testing-mistakes/banner
...
[Testing JS course](https://abhidev.com). (see what I did there?)
...
In [my course](https://abhidev.com) I'll show you the right way to
