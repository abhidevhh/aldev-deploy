...
translations:
  - language: 繁體中文
    link: https://medium.com/@GQSM/react-unit-test-%E7%82%BA%E5%9F%B7%E8%A1%8C%E7%B4%B0%E7%AF%80%E5%AF%AB%E4%B8%8B%E6%B8%AC%E8%A9%A6-%E7%BF%BB%E8%AD%AF-7bec3bca4ee1
  - language: 简体中文
    link: https://mp.weixin.qq.com/s/cTCQH6VjcQDPmvBb0YveFw
  - language: Português
    link: https://mikeoli.hashnode.dev/testando-detalhes-de-implementacao
  - language: 日本語
    link: https://zenn.dev/pandanoir/articles/fe052e716d5c87
  - language: Русский
    link: https://emeraldweb.vercel.app/code/articles/testing-implementation-details-ru
  - language: 한국어
    link: https://soojae.tistory.com/84
  - language: Español
    link: https://www.redradix.com/insights/detalles-implementacionl-tests-articulo-de-abhic-dodds
    author:
      name: Virgilio Gómez
      link: https://github.com/virgilio-redradix
bannerCloudinaryId: abhidev.com/content/blog/testing-implementation-details/banner
bannerCredit: Photo by [rawpixel](https://unsplash.com/photos/1Z15APktAiY)
---
...
```tsx remove=2-3,7,16 add=4-5,8,17
class Accordion extends React.Component {
  state = {openIndex: 0}
  setOpenIndex = openIndex => this.setState({openIndex})
  state = {openIndexes: [0]}
...
[pit](https://x.com/abhidev/status/859994199738900480) of
...
![happy goats](https://res.cloudinary.com/abhidev-com/image/upload/v1625033409/abhidev.com/content/blog/testing-implementation-details/0.gif)
