...
date: 2021-09-29
description:
  I rewrote abhidev.com using the latest technologies and I want to talk
  about what I did.
categories:
  - react
  - remix
...
meta:
  keywords:
    ...
    - tailwind css
    - magic links
bannerCloudinaryId: abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/banner_iplhop
bannerAlt: MacBook Pro on top of brown table
bannerCredit: Photo by [Kari Shea](https://unsplash.com/photos/1SAnrIxw5OY)
---

For over half of 2021, I worked on a complete rewrite of abhidev.com. You're
...
into [the call AbhiDev Podcast](/calls)? This blog post isn't about these and other
...
[Introducing the new abhidev.com](/blog/introducing-the-new-abhidev.com)
first.
...
But again, that's not what abhidev.com is. If you're interested in how to
...
[the Engineering with AbhiDev Podcast](/chats) comes to about 35 hours of content + the
ever-growing 3 hours of content on the brand new [call AbhiDev Podcast](/calls)
...
[November 2020](https://github.com/abhidev/abhidev.com/commit/4fefae1389a7c3faea2fc2b321d0953a80d0e414).
...
<Themed
	dark={
		<a
			href="https://github.com/abhidev/abhidev.com/graphs/contributors"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/contributor-graph-dark"
	...
	light={
		...
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/contributor-graph-light"
				imgProps={{ alt: 'GitHub contributor graph' }}
			/>
		</a>
	}
...
- [ESBuild](https://esbuild.github.io/): JavaScript bundler (used by Remix and
  mdx-bundler).
- [mdx-bundler](https://github.com/abhidev/mdx-bundler): Tool for compiling
...
- [Metronome](https://metronome.sh): Remix metrics service (deprecated service)
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-dark"
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/deployment-pipeline-light"
				imgProps={{ alt: 'Excalidraw diagram of a deployment pipeline' }}
			/>
		</a>
	}
...
me explain the problem it solves. The previous version of abhidev.com was
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/database-connectivity-light"
				imgProps={{
					alt: 'Excalidraw diagram of a databases in different regions',
				}}
			/>
...
[The call AbhiDev Podcast](/calls), they hit the closest server to them (Amsterdam)
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/fly-request-replays-light"
				imgProps={{
					alt: 'Excalidraw diagram of a user POST request made to different regions being routed to the primary region',
				}}
			/>
...
[submit a recording](/calls/record/new) to [The call AbhiDev Podcast](/calls)),
...
same for the images on [The call AbhiDev Podcast](/calls). It's bonkers.
...
[`mdx-bundler`](https://github.com/abhidev/mdx-bundler). I started with
...
export default function UsersPage({ loaderData: data }) {
	return (
		<div>
			<h1>Users</h1>
			<ul>
...
https://x.com/abhidev/status/1299758509312024576
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/auth-flow-light"
				imgProps={{
					alt: 'Excalidraw diagram of a user going to the login screen, clicking the magic link, and getting authenticated',
				}}
			/>
...
<Themed
	dark={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-dark"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-dark"
				imgProps={{
	...
	light={
		<a
			href="https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-light"
			target="_blank"
		>
			<BlogImage
				cloudinaryId="abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/session-flow-light"
				imgProps={{
					alt: 'Excalidraw diagram of a user going to an authenticated page and the session being resolved to a user or the user getting redirected to login',
				}}
			/>
...
![Remix logo](https://res.cloudinary.com/abhidev-com/image/upload/abhidev.com/content/blog/how-i-built-a-modern-website-in-2021/remix)
