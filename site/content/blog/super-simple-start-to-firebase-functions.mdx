...
![Firebase console showing an "Add project" button](https://res.cloudinary.com/abhidev-com/image/upload/v1625033386/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-1-firebase-console.png)
...
![Let's start with a name for your project. Project name: My Awesome Firebase Thing. my-awesome-firebase-thin-33d3a. A unique identifier for your project](https://res.cloudinary.com/abhidev-com/image/upload/v1625033386/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-1-2-firebase-name.png)
...
![Firebase console showing the setting page with the Project ID](https://res.cloudinary.com/abhidev-com/image/upload/v1625033387/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-3-project-id.png)
...
![Terminal output from the firebase login command](https://res.cloudinary.com/abhidev-com/image/upload/v1625033387/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-8-login.png)
...
![Emulator overview](https://res.cloudinary.com/abhidev-com/image/upload/v1625033387/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-9-emulator-overview.png)

If you hit your serverless function in a browser you should see the output:

![Browser saying "Hello World!"](https://res.cloudinary.com/abhidev-com/image/upload/v1625033387/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-9-fn-output.png)

And then your logs will show that the function was run:

![Function logs](https://res.cloudinary.com/abhidev-com/image/upload/v1625033386/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-9-fn-logs.png)
...
![Usage and billing settings page](https://res.cloudinary.com/abhidev-com/image/upload/v1625033387/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-11-usage-and-billing.png)

Then you'll click "Modify plan" and then "Select plan" under "Blaze Pay as you
go":

![Firebase billing plans](https://res.cloudinary.com/abhidev-com/image/upload/v1625033386/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-11-firebase-billing-plans.png)
...
![Browser saying "Hello Bob Ross!"](https://res.cloudinary.com/abhidev-com/image/upload/v1625033386/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-12-deployed-fn-output.png)
...
![GitHub secrets UI adding the firebase token](https://res.cloudinary.com/abhidev-com/image/upload/v1625033387/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-14-add-secret.png)
...
![Action output showing the deploy](https://res.cloudinary.com/abhidev-com/image/upload/v1625033386/abhidev.com/content/blog/super-simple-start-to-firebase-functions/step-16-action-output.png)
...
[the finished repo here](https://github.com/abhidev/super-simple-firebase-function-example).
