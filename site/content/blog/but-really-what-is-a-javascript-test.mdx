...
date: 2018-01-01
description:
  Let's take a step back and understand automated testing of JavaScript from
  square one.
meta:
  keywords:
    - javascript
...
translations:
  - language: 한국어
    link: https://codesnapmag.hashnode.dev/javascript-test
    author:
      name: Hyunji Seok
      link: https://somebodylovesusall.medium.com/
bannerCloudinaryId: unsplash/photo-1478001517127-fccc92f54906
bannerCredit: Photo by [Joshua Earle](https://unsplash.com/photos/xEh4hvxRKXM)
---

Testing software. There are a ton of reasons we do it. Here are two of mine:
...
- [Have you ever written a JavaScript test?](https://x.com/abhidev/status/942625485829181441)
- [Have you ever used a JavaScript Testing Framework?](https://x.com/abhidev/status/942625486638759938)
- [Have you ever set up a JavaScript testing framework from scratch?](https://x.com/abhidev/status/942625487511154688)
- [Do you understand testing frameworks well enough to implement your own? (even a really simple one?)](https://x.com/abhidev/status/942625489348280320)
...
**I've made [a repo on GitHub](https://github.com/abhidev/js-test-example)
...
![Screenshot of the output from running jest](https://res.cloudinary.com/abhidev-com/image/upload/v1625032584/abhidev.com/content/blog/but-really-what-is-a-javascript-test/0.png)
