...
} from '#app/utils/abhi-call-artwork.ts'
...
export function EpisodeArtworkPreview({
	...
	const tooltip = isAnonymous
		? `Anonymous is enabled. Your call still shows up in Kent's admin with your info, but the published episode artwork uses a generic AbhiBuddy avatar instead of your photo.`
		: `If you check this, your call still shows up in Kent's admin with your info, but the published episode artwork will use a generic AbhiBuddy avatar instead of your photo.`
