...
import { AnchorOrLink } from '#app/utils/misc-react'
import { useRootData } from '#app/utils/use-root-data'
import { externalLinks } from '../external-links'
import { KitForm } from '../kit/form'
import { IconLink } from './icon-link'
import { ArrowIcon, GithubIcon, RssIcon, XIcon, YoutubeIcon } from './icons'
	...
	return (
		<div>
			...
			<ul className="mt-4">
				...
				<FooterLink name="call AbhiDev" href="/calls" />
	...
	return (
		<div>
			...
			<ul className="mt-4">
				...
				<FooterLink name="Portfolio" href="/courses" />
	...
	return (
         ...
         */}
					...
					<div className="col-span-full mt-24 text-lg text-gray-500 md:mt-44 dark:text-slate-500">
						...
						<span className="block md:inline">{`© AbhiDev ${new Date().getFullYear()}`}</span>
					</div>
				</div>
			</div>
		</footer>
