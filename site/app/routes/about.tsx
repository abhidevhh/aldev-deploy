		...
		<>
			...
			<Grid as="main" className="mt-16 mb-24 lg:mb-48">
				<div className="col-span-full">
					<div className="rounded-3xl overflow-hidden bg-black shadow-lg shadow-black/20">
						<BackgroundYouTubeEmbed
							id="mUnMSwmqg2w"
					...
					<p className="mt-6 text-xl text-slate-500">{`Listen to this full Formula One racing car music track live on the page.`}</p>
					<a
			...
			<Grid className="mt-16 mb-24 lg:mb-48">
				...
				<div className="col-span-full mb-8 lg:col-span-8 lg:mb-20">
					<H2 as="p" className="mb-8">
						{`I am a passionate AI Engineer from India focused on intelligent systems, NLP, and computer vision.`}
					</H2>
          ...
          `}
			...
			<Grid className="mb-24 lg:mb-64">
				...
				<div className="col-span-full lg:col-span-5 lg:col-start-1 lg:row-start-1">
					<H2 className="mb-10">Here are the principles that guide my engineering journey.</H2>
