...
import { Grimmacing } from '#app/components/kifs'
import { H4, Paragraph } from '#app/components/typography'
import { type RootLoaderType } from '#app/root'
import { AbhiCallTextToSpeech } from '#app/routes/resources/calls/text-to-speech'
			...
			{audio ? (
              ...
              `}
						...
						<div>
							...
							<AbhiCallTextToSpeech
								onAcceptAudio={({ audio, questionText }) => {
									setAudio(audio)
									const formattedNotes =
										formatAbhiCallTextToSpeechNotes(questionText)
									setPrefill({
										fields: {
