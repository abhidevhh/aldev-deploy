...
type AbhiCallEpisodeArtworkOptions = {
	title: string
	/**
	 * Display URL text rendered in the artwork (no protocol recommended).
	 * Example: "abhidev.com/calls/01/01"
	 */
	url: string
	/**
	 ...
	 * - Use `public` for Cloudinary assets (ex: AbhiBuddy) to keep URLs short.
	 */
	avatar: AbhiCallEpisodeArtworkAvatar
	/**
...
export function getAbhiCallEpisodeArtworkAvatar({
	isAnonymous,
	team,
	gravatarUrl,
}: {
...
/**
 * Generates the Cloudinary URL for call AbhiDev episode artwork.
 *
 ...
 */
export function getAbhiCallEpisodeArtworkUrl({
	title,
	url,
	name,
	avatar,
