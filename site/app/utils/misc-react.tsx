...
const avatarFallbacks: Record<OptionalTeam, (width: number) => string> = {
	BLUE: (width: number) => images.abhiBuddyProfileBlue({ resize: { width } }),
	RED: (width: number) => images.abhiBuddyProfileRed({ resize: { width } }),
	YELLOW: (width: number) => images.abhiBuddyProfileYellow({ resize: { width } }),
	UNKNOWN: (width: number) => images.abhiBuddyProfileGray({ resize: { width } }),
}
