...
export async function generateAbhiCallEpisodeMetadataWithWorkersAi({
	...
	const system = `
You write metadata for the "Call Kent Podcast", hosted by AbhiDev.
