...
test('requestAbhiCallEpisodeAudioGeneration enqueues cloudflare queue message', async () => {
	vi.clearAllMocks()
	process.env.ABHI_CALL_AUDIO_CF_QUEUE_ID = 'queue-123'
	process.env.ABHI_CALL_AUDIO_CF_API_BASE_URL =
...
test('requestAbhiCallEpisodeAudioGeneration throws on cloudflare queue errors', async () => {
	vi.clearAllMocks()
	process.env.ABHI_CALL_AUDIO_CF_QUEUE_ID = 'queue-123'
	process.env.ABHI_CALL_AUDIO_CF_API_BASE_URL =
		'https://api.cloudflare.com/client/v4'
	...
	await expect(
		requestAbhiCallEpisodeAudioGeneration({
			draftId: 'draft-1',
			callAudioKey: 'abhi-call/calls/call-1/call.webm',
			responseAudioKey: 'abhi-call/drafts/draft-1/response.webm',
		}),
...
test('requestAbhiCallEpisodeAudioGeneration throws on cloudflare queue timeout', async () => {
	vi.clearAllMocks()
	process.env.ABHI_CALL_AUDIO_CF_QUEUE_ID = 'queue-123'
	process.env.ABHI_CALL_AUDIO_CF_API_BASE_URL =
		'https://api.cloudflare.com/client/v4'
...
test('requestAbhiCallEpisodeAudioGeneration throws on empty cloudflare queue response', async () => {
	vi.clearAllMocks()
	process.env.ABHI_CALL_AUDIO_CF_QUEUE_ID = 'queue-123'
	process.env.ABHI_CALL_AUDIO_CF_API_BASE_URL =
		'https://api.cloudflare.com/client/v4'
...
test('requestAbhiCallEpisodeAudioGeneration rejects cloudflare responses without success=true', async () => {
	vi.clearAllMocks()
	process.env.ABHI_CALL_AUDIO_CF_QUEUE_ID = 'queue-123'
	process.env.ABHI_CALL_AUDIO_CF_API_BASE_URL =
		'https://api.cloudflare.com/client/v4'
...
test('requestAbhiCallEpisodeAudioGeneration surfaces response body read failures', async () => {
	vi.clearAllMocks()
	process.env.ABHI_CALL_AUDIO_CF_QUEUE_ID = 'queue-123'
	process.env.ABHI_CALL_AUDIO_CF_API_BASE_URL =
		'https://api.cloudflare.com/client/v4'
