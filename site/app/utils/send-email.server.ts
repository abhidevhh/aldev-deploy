...
<center><img src="https://res.cloudinary.com/abhidev-com/image/upload/w_800,q_auto,f_auto/${randomSportyAbhiBuddy.id}" style="max-width: 80%;${
				randomSportyAbhiBuddy.style?.aspectRatio
					? `aspect-ratio: ${randomSportyAbhiBuddy.style.aspectRatio};`
					: ''
			}"></center>
