import { f as getRandomFlyingAbhiBuddy } from "./images-D8NqauwH.js";
import { g as getEnv } from "./env.server-DPCBxZtL.js";
import { b as markdownToHtmlDocument } from "./markdown.server-C6vYtRmU.js";
import { q as getOptionalTeam } from "./misc-DM3BUXHg.js";
const {
...
async function sendVerificationCodeEmail({
  ...
  const sender = `"AbhiDev Team" <team+kcd@kentcdodds.com>`;
  const { hostname } = new URL(domainUrl);
  const randomSportyAbhiBuddy = getRandomFlyingAbhiBuddy(
    team ? getOptionalTeam(team) : void 0
  );
  const text = `
${title} for ${hostname}
...
<center><img src="https://res.cloudinary.com/abhidev-com/image/upload/w_800,q_auto,f_auto/${randomSportyAbhiBuddy.id}" style="max-width: 80%;${randomSportyAbhiBuddy.style?.aspectRatio ? `aspect-ratio: ${randomSportyAbhiBuddy.style.aspectRatio};` : ""}"></center>
...
export {
  ...
  sendSignupVerificationEmail as b,
  sendEmail as s
};
//# sourceMappingURL=send-email.server-BOafejnl.js.map
