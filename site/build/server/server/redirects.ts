...
export const oldImgSocial: RequestHandler = (req, res) => {
	res.redirect(
		'https://res.cloudinary.com/abhidev-com/image/upload/$th_1256,$tw_2400,$gw_$tw_div_24,$gh_$th_div_12/co_white,c_fit,g_north_west,w_$gw_mul_10,h_$gh_mul_7,x_$gw_mul_1.3,y_$gh_mul_1.5,l_text:abhidev.com:Matter-Regular.woff2_110:Helping%2520people%2520make%2520the%2520world%2520a%2520better%2520place%2520through%2520quality%2520software./c_fit,g_north_west,r_max,w_$gw_mul_4,h_$gh_mul_3,x_$gw,y_$gh_mul_8,l_abhi:profile-transparent/co_rgb:a9adc1,c_fit,g_north_west,w_$gw_mul_5.5,h_$gh_mul_4,x_$gw_mul_4.5,y_$gh_mul_9,l_text:abhidev.com:Matter-Regular.woff2_70:AbhiDev/co_rgb:a9adc1,c_fit,g_north_west,w_$gw_mul_5.5,x_$gw_mul_4.5,y_$gh_mul_9.8,l_text:abhidev.com:Matter-Regular.woff2_40:abhidev.com/c_fit,g_east,w_$gw_mul_11,h_$gh_mul_11,x_$gw,l_abhidev.com:illustrations:kody:kody_snowboarding_flying_blue/c_fill,w_$tw,h_$th/abhidev.com/social-background.png',
	)
}
